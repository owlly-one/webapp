...
const Blog = ({ blog }) => {
    return (
        <>
            ...
            />
            <div className={styles.single_article_page} style={{backgroundColor: "white"}}>
                <div className={styles.blogs_section}>
                    <BlogCard blog={blog} type = "physical" />
                </div>
...
export async function getServerSideProps(context) {
    ...
    let url = process.env.NEXT_PUBLIC_BASE_URL + "physical/" + id
